...
function(wipro_print_configuration_summary)
  ...
  wipro_status("Description         : ${PROJECT_DESCRIPTION}")
  ...
  wipro_status("  Release CXX flags :   ${CMAKE_CXX_FLAGS_RELEASE}")
  wipro_status("  Debug CXX flags   :   ${CMAKE_CXX_FLAGS_DEBUG}")
...
#  wipro_status("  USE_SERVER        :   ${USE_SERVER}")
  ...
  wipro_status("  Exiv2             :   ${EX_FOUND} (ver. ${EXIV2_VERSION})")
